...
public record RiskAdjustedMomentumBacktestResult(
        ...
        String stopModel, double trailingStopPercent, int cooldownWeeks,
        ...
        List<StopEvent> stopOutEvents, List<RegimePoint> regimeExposureHistory
) {
    ...
    public record StopEvent(String ticker, LocalDate entryDate, double entryPrice, double peakPrice,
                            double stopLevel, LocalDate signalDate, LocalDate executionDate,
                            double executionPrice, long quantity, double realizedProfitLoss,

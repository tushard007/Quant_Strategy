...
@Entity
@Table(name = "risk_adjusted_momentum_backtest_run")
@Getter
@Setter
public class RiskAdjustedMomentumBacktestRun {
    @Id
    ...
    @Column(nullable = false)
    private String stopModel;
    @Column(nullable = false)
    private double trailingStopPercent;
    @Column(nullable = false)
    private int cooldownWeeks;
    @Column(nullable = false)
    private int benchmarkSmaPeriod;
    @Column(nullable = false)
    private double breadthThresholdPercent;
    @Column(nullable = false)
    private double weakExposureCapPercent;
    @Column(nullable = false)
    ...
    private RiskAdjustedMomentumBacktestResult result;
}

...
@Repository
public interface TopRiskAdjustedMomentumStockRepository extends JpaRepository<TopN_RiskAdjustedMomentumAssetType, Integer> {
    List<TopN_RiskAdjustedMomentumAssetType> findByAssetDataTypeAndStrategyRunDateOrderByRank12MonthsAsc(AssetDataType assetDataType, Date strategyRunDate);

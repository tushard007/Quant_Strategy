...
public class ETFMasterController {
    ...
    @PutMapping("/commodity-selection") public List<NSE_ETFMasterData> updateCommoditySelection(@Valid @RequestBody ETFCommoditySelectionRequest request) { return service.updateCommoditySelection(request); }

...
export interface ETFMaster { id:number; symbol:string; underlying:string; securityName:string; dateOfListing:string; marketLot:number; isinNumber:string; faceValue:number; }
